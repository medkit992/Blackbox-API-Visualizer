...
`v0.1.1` is the current repository version and should become the first Stable release only after the exact Chrome Web Store build passes the release verification checklist in [`docs/release-policy.md`](release-policy.md).
